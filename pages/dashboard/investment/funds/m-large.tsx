              ...
              <Box display="flex" alignItems="center" className="nameCoin">
                ...
                <Box>
                  ...
                  <Typography className="text_xs" style={{ marginTop: 5 }}>
                    กลยุทธ์ที่คัดสรรกลุ่มสินทรัพย์อันดับต้นของตลาด พร้อมการ
                    Rebalance อัตโนมัติเพื่อประสิทธิภาพสูงสุด
                  </Typography>
                </Box>
              </Box>
            </Grid>
        ...
        <Grid container spacing={3}>
          <Grid item sm={9} xs={12}>
            ...
            <Typography className="text_sm" style={{ marginTop: 10 }}>
              ในโลกยุคดิจิทัลสินทรัพย์ดิจิทัลจะเข้ามาเปลี่ยนแปลงโลกการเงินเหมือนกับที่อินเตอร์เน็ตได้เปลี่ยนโลกเมื่อหลายสิบปีที่ผ่านมา
              ด้วยคุณสมบัติของเทคโนโลยีบล็อคเชนที่เป็นระบบเปิด ไร้ตัวกลาง
              ไร้พรมแดน และ ปิดกั้นไม่ได้
              สินทรัพย์ดิจิทัลจะกลายเป็นกลไกสาคัญในระบบเศรษฐกิจใหม่นี้
              และจะมาเปลี่ยนแปลงตลาดทุนอย่างหลีกเลี่ยงไม่ได้
              เรียกได้ว่าเป็นโอกาสในการลงทุนรูปแบบใหม่เสมือนได้เลือกลงทุนในบริษัท
              Startup ที่จะมาปฏิรูปโลกในอนาคต
            </Typography>
          </Grid>
        ...
        <Box className="tabFunds">
          ...
          >
            ...
            <TabPanel value={tabs} index={1}>
              <Typography className="text_sm color_warning mb_2">
                *สัดส่วนการลงทุนเป็นเพียงตัวอย่างเท่านั้น
                โดยบริษัทจะมีการปรับเปลี่ยนตามความเหมาะสม
              </Typography>
              <Box className="imageCoin">
                <img src="/images/m-large.png" alt="" />
              </Box>
