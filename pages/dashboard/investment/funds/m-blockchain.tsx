      ...
      <Box className={classes.root}>
        ...
        <Box className="boxTop mt_2" position="relative">
          ...
          <ButtonDefault
            ...
            onClick={() =>
              router.push({
                pathname: "/investment/funds/deposit",
              })
            }
          />
        </Box>
        <Grid container spacing={3}>
          <Grid item sm={9} xs={12}>
            ...
            <Typography className="text_sm" style={{ marginTop: 10 }}>
              ...
              Platform ที่เป็นแกนหลักสาคัญของเทคโนโลยีบล็อกเชน M-BLOCKCHAIN
              จึงเป็นทางเลือกการลงทุนในสินทรัพย์ดิจิทัลประเภท Blockchain
              Platform และ Smart Contract Platform อย่างเช่น เทคโนโลยี Layer 1,
              Layer 2 ที่เป็นรากฐาน หลักของ Blockchain
          ...
          >
            ...
            <TabPanel value={tabs} index={1}>
              <Box className="imageCoin">
                <img src="/images/m_blockchain.png" alt="" />
              </Box>
...
export default MBlockchainPage;
