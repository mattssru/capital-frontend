              ...
              <Box display="flex" alignItems="center" className="nameCoin">
                ...
                <Box>
                  ...
                  <Typography className="text_xs" style={{ marginTop: 5 }}>
                    กลยุทธ์ที่ลงทุนในกลุ่มสินทรัพย์ Metaverse พร้อมการ Rebalance
        ...
        <Grid container spacing={3}>
          <Grid item sm={9} xs={12}>
            ...
            <Typography className="text_sm" style={{ marginTop: 10 }}>
              ในช่วงปีที่ผ่านมา
              เทคโนโลยีในด้านบล็อกเชนนั้นได้เติบโตอย่างก้าวกระโดดและได้เป็นรากฐานของเทคโนโลยี
              Web3.0 ที่ผู้ใช้งานสามารถเข้าถึงข้อมูลข่าวสาร หรือ บริการต่าง ๆ
              ได้อย่าง อิสระและมีสิทธิความเป็นเจ้าของข้อมูลตนเองอย่างเต็มที่
              โดยภายหลังสามารถต่อยอดไปสู่ Metaverse
              ซึ่งเป็นเทคโนโลยีที่จะนำเอาโลกจริงและโลกเสมือนมาผนวกกันได้เป็นมิติใหม่ที่
              อาจมาพลิกโฉมชีวิตของผู้คนไปตลอดกาล ผู้คนจะสามารถทากิจกรรมต่าง ๆ
              ร่วมกันได้ ไม่ว่าจะเป็นการเล่นเกม การทางานร่วมกัน
              หรือการใช้ชีวิตแบบออนไลน์โดยอาศัยเทคโนโลยีใน การสร้างโลกเสมือนจริง
              โดยเทคโนโลยี Metaverse นี้มีศักยภาพที่จะ Disrupt
              การใช้ชีวิตและพฤติกรรมของผู้คนเหมือนกับโซเชียลมีเดียที่ใช้เทคโนโลยี
              Web2.0 แต่ด้วยความสามารถ ของบล็อกเชนที่เป็นระบบเปิด ไร้ตัวกลาง
              ไร้พรมแดน และไม่ถูกปิดกั้น จึงเป็นไปได้อย่างมากว่าเทคโนโลยี Web3.0
              และ Metaverse Ecosystem จะเป็นเทคโนโลยีที่ควรค่าแก่การศึกษา
              และจับตามองเป็นอย่างยิ่ง M-METAVERSE
              จึงเป็นทางเลือกการลงทุนรูปแบบใหม่ให้นักลงทุนเสมือนได้ลงทุนในสินทรัพย์ดิจิทัลแกนหลักสาคัญของ
              Metaverse ไม่ว่าจะเป็นใน Ecosystem ที่กาลังจะเกิดขึ้น รวมไปถึง
              Games, NFT และ Infrastructure ต่าง ๆ
              ที่อาจมาปฏิวัติการใช้ชีวิตของผู้คนไปตลอดกาล
            </Typography>
          </Grid>
          ...
          >
            <TabPanel value={tabs} index={0}>
              ...
              <Typography className="text_sm">
                บริษัทจะเน้นลงทุนในสินทรัพย์ดิจิทัลที่เป็นแกนหลักของ Blockchain
                Infrastructure เต็มอัตรา (Fully Invested)
                โดยจะลงทุนในสินทรัพย์ดิจิทัลระดับสากลตามมาตรฐาน และตาม
                Investment Framework ของบริษัทตามที่เห็นชอบให้ลงทุนได้ ได้แก่
                สินทรัพย์ดิจิทัลที่เกี่ยวข้องกับ Blockchain Infrastructure เช่น
                ETH
                และคู่แข่งสำคัญที่กำลังกินส่วนแบ่งทางการตลาดที่เติบโตอย่างรวดเร็ว
                โดยเลือกสินทรัพย์ดิจิทัลที่เข้าหลักเกณฑ์ในการคัดเลือกซึ่งได้พิจารณาถึงมูลค่าสินทรัพย์ดิจิทัล
            ...
            <TabPanel value={tabs} index={1}>
              <Box className="imageCoin">
                <img src="/images/m_metaverse.png" alt="" />
              </Box>
